 ...
 * Alipay API example.
 */
exports.getAlipay = (req, res) => {
  res.render('api/alipay', {
    title: 'Alipay API',
 ...
 * Alipay API example.
 */
exports.getNabNew = (req, res) => {
  res.render('api/upload', {
    title: 'New NAB Account',
    publishableKey: process.env.STRIPE_PKEY
  });
};
 ...
 * Alipay API example.
 */
exports.getRealEstaet = (req, res) => {
  res.render('api/realestate', {
...
/**
 * GET /api/alimerchants
 * Alimerchants API example.
 */
exports.getAlimerchants = (req, res) => {
  res.render('api/alimerchants', {
    title: 'Ali Merchants Services',
    publishableKey: process.env.STRIPE_PKEY
  });
};
...
/**
 * GET /api/alibuy
 * Alipay transaction API example.
 */
exports.getAliBuy = (req, res) => {
  res.render('api/alibuy', {
    title: 'Alipay Transaction Page',
    publishableKey: process.env.STRIPE_PKEY
  });
};
 ...
 * Alipay transaction API example.
 */
exports.getAliBuyDone = (req, res) => {
  res.render('api/alibuydone', {
    title: 'Alipay Transaction Done Page',
    publishableKey: process.env.STRIPE_PKEY
  });
};
...
/**
 * GET /api/alireports
 * Alireports API example.
 */
exports.getAliReports = (req, res) => {
  res.render('api/alireports', {
    title: 'Ali Personal Financial Report',
    publishableKey: process.env.STRIPE_PKEY
  });
};
 ...
 * Alireports API example.
 */
exports.getNabReports = (req, res) => {
  res.render('api/nabreports', {
    title: 'nab Account Information',
    publishableKey: process.env.STRIPE_PKEY
  });
};
